...
?>
<!--Financial Products -->
<div  id="fanancialProduct" class='gradient-one'>
	<div class='container-fluid gradient-one get-Quote-form'>
...
<section  id="aboutUsSection" class="gradient-two">
	<div class="container text-center">
		<p>Supporting small business for <b>18 years</b> with over <b>$6 billion</b> in working capital.</p>
		<a href="javascript:void(0);" class="btn btn-purple-style">ABOUT US</a>
	</div>
</section>
<section  id="getFunded">
	<div class="container text-center">
		<h1> Get Funded </h1>
