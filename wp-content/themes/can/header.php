                    ...
                    <div class="container-fluid">			  	
                        <div id="main_navigationbar" class="row primary-nav">  	
                            <div class="navbar-header ">
                                ...
                                <a href="<?php echo site_url(); ?>" title="CANCAPITAL" class="navbar-brand" href="<?php echo site_url(); ?>"> <img src="<?php echo get_template_directory_uri(); ?>/images/CAN-logo.png" alt="CAN CAPITAL LOGO"> </a>
                            </div>
                        ...
                        <?php
                        $head_line = get_post_meta($post->ID, 'wpcf-page-headline-title', true);
                        ?>
                        <div class="top-heading"><?php echo $head_line; ?></div>
						<?php 
						if ( is_front_page() ) {
							?>
