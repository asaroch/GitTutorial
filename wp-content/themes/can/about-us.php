...
?>
            ...
            <section id="email_us" class="gray-bg">
                <div class="container text-center">
                    ...
                    <a href="mailto:mailto:anirudh.sood@trantorinc.com?subject=Want%20to%20learn%20more&body=Hi%20,Anirudh" title="APPLY NOW" class="btn btn-blue-bg"> <?php echo $email_us_button; ?> <i class="glyphicon glyphicon-play"></i></a>
                </div>
            </section>
            <!-- Email Us -->
