...
<section  class="get-funded">
    <div class="container text-center">
        <h2 class="section-heading"> <?php echo get_post_meta($how_it_works_id, 'wpcf-cta-title', true); ?></h2>
        <h3> <?php echo get_post_meta($how_it_works_id, 'wpcf-cta-description', true); ?></h3>
